    ...
    <div className="uppercase my-10">
      ...
      {team.data && (
        <div className="overflow-x-auto">
          <table className="mx-auto my-5 table-auto border-collapse border border-slate-400 min-w-full">
            <thead className="2xl:text-xl xl:text-base md:text-sm text-[7px]">
              <tr>
            ...
            <tbody>
              <tr
                className="border 2xl:text-lg xl:text-xs lg:text-xs md:text-[10px] text-[6px] border-slate-600 text-center"
                key={team._id}
              >
