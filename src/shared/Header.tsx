    ...
    >
      ...
      >
        <div className="grid  2xl:w-[200px] xl:w-[120px] lg:min-w-full    gap-3">
          ...
          <h1 className="  2xl:text-lg  xl:text-base   lg:text-sm  text-xs text-white font-bold text-center">
            {name.firstName} {name.lastName}
          </h1>
          <Link
            href={"/dashboard/profile"}
            className=" grid rounded-md  2xl:leading-8 xl:leading-6 lg:leading-5 md:leading-4  leading-3 w-full j justify-center items-center  text-white font-bold  text-center  bg-[#FF914F]     2xl:text-lg  xl:  xl:text-base  lg:text-sm text-xs  capitalize"
          >
            {" "}
            view profile{" "}
          </Link>{" "}
          <nav className="  2xl:text-lg xl:text-base  lg:text-sm text-xs capitalize text-white  grid gap-y-3">
